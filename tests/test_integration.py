...
from tests.conftest import SEED_0, ED25519_SIGNING_KEY
...
class TestQueuerFlushSubmitsTransaction:
    ...
    def test_flush_single_event_anchors_on_chain(self, w3, contract, backer_account):
    ...
    def test_flush_multiple_events_all_anchored(self, w3, contract, backer_account):
    ...
    def test_flush_empty_is_noop(self, w3, contract, backer_account):
        """flush() with empty queue returns None without submitting a tx."""
        queuer = Queuer(w3=w3, contract=contract, backer_account=backer_account, signing_key=ED25519_SIGNING_KEY)
        result = queuer.flush()
        assert result is None

    def test_flush_respects_max_batch_size(self, w3, contract, backer_account):
    ...
    def test_flush_updates_pending_txs(self, w3, contract, backer_account):
...
class TestTransactionSubmitFlow:
    ...
    def test_build_and_submit_anchor_tx(self, w3, contract, backer_account):
        ...
        signed_tx = build_anchor_tx(w3, contract, backer_account, anchors, signing_key=ED25519_SIGNING_KEY)
    ...
    def test_build_anchor_tx_batch_of_three(self, w3, contract, backer_account):
...
class TestCrawlerTrackAndCheck:
    ...
    def test_crawler_confirms_after_confirmation_depth(self, w3, contract, backer_account):
        ...
        receipt = _send_anchor_tx(w3, contract, backer_account, prefix, sn, said)
        assert receipt.status == 1
    ...
    def test_crawler_still_pending_before_confirmation_depth(self, w3, contract, backer_account):
...
class TestFullPipeline:
    ...
    def test_pipeline_enqueue_flush_track_confirm(self, w3, contract, backer_account):
