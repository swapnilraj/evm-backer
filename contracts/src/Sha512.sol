...
/// @title  Sha512
/// @notice Pure Solidity SHA-512 implementation for Ed25519 signature verification.
...
library Sha512 {
    ...
    function ROTR(uint64 x, uint256 n) internal pure returns (uint64) {
        return uint64(uint256(x) << (64 - n)) | (x >> n);
    }
    ...
    function hash(bytes memory data) internal pure returns (uint64[8] memory) {
        ...
        for (uint256 j = 0; j < blocks.length / 128; j++) {
            ...
            fvar.a = H[0]; fvar.b = H[1]; fvar.c = H[2]; fvar.d = H[3];
            fvar.e = H[4]; fvar.f = H[5]; fvar.g = H[6]; fvar.h = H[7];
            ...
            for (uint256 i = 0; i < 80; i++) {
                ...
                fvar.g = fvar.f;
                fvar.f = fvar.e;
                unchecked { fvar.e = fvar.d + T1; }
                fvar.d = fvar.c;
                fvar.c = fvar.b;
                fvar.b = fvar.a;
                unchecked { fvar.a = T1 + T2; }
            }

            unchecked {
                H[0] = H[0] + fvar.a; H[1] = H[1] + fvar.b;
                H[2] = H[2] + fvar.c; H[3] = H[3] + fvar.d;
                H[4] = H[4] + fvar.e; H[5] = H[5] + fvar.f;
                H[6] = H[6] + fvar.g; H[7] = H[7] + fvar.h;
            }
        }
